export const speciesData = [
  {
    ...
    description:
      'A terrestrial snail known for its variable shell color patterns, often found in gardens and grassy areas.',
  },
  {
    id: 11,
    ...
    description:
      'Also known as pillbugs, they are terrestrial crustaceans, known for their ability to roll into a ball.',
  },
  {
    id: 12,
    ...
    description:
      'A small jumping spider recognizable by its black and white striped pattern, known for its agile movement.',
  },
  {
    id: 13,
    ...
    description:
      'A vital soil organism that aerates and enriches the soil through its burrowing and feeding habits.',
  },
  {
    id: 1,
    ...
    description:
      'A small, delicate insect recognized by its green wings and golden eyes, useful for controlling pests.',
  },
  {
    id: 2,
    ...
    description:
      'Social insects renowned for their vital role in pollination and honey production.',
  },
  {
    id: 5,
    ...
    description:
      'Small social insects that live in colonies and play important roles in the ecosystem.',
  },
  {
    id: 8,
    ...
    description:
      'Recognizable by their distinctive red or orange color with black spots, they are beneficial insects in pest control.',
  },
  {
    id: 15,
    ...
    description:
      'A small, slender damselfly recognized for its striking blue coloration and black markings, often found near freshwater.',
  },
  {
    id: 18,
    ...
    description:
      'A distinctive moth known for its striking black and white coloration and hairy caterpillars, which are often found on plants.',
  },
  {
    id: 17,
    ...
    description:
      'A small, green weevil recognized for its elongated snout; it causes minimal damage to plants but can be a pest in gardens.',
  },
  {
    id: 19,
    ...
    description:
      'The larval stage of the Lophocampa maculata, recognized for its bright yellow color and long hair-like setae, often considered harmless.',
  },
];
